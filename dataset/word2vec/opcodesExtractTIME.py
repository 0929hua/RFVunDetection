...
if __name__ == "__main__":
    conOpCodesPath = 'D:/pyProjects/pythonProject/MachineLearningVulnerabilityDetection/dataset/opcodes/timestamp/'
    ...
    for file in conOpCodesPathList:
                ...
                if len(opFe):
                    ...
                    if len(listLast):
                        ...
                        print('ok')
    print(label)
    textl = open("./timestamp/labelListTIMESTAMP.txt", "a")
